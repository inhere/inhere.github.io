---
title: GCli v3.5 发布：自动补全、命令中间件、帮助信息分组、结构体绑定优化等
...
- 完整文档：[https://pkg.go.dev/github.com/gookit/gcli/v3](https://pkg.go.dev/github.com/gookit/gcli/v3)
- 完整变更：[v3.3.1...v3.5.0](https://github.com/gookit/gcli/compare/v3.3.1...v3.5.0)
