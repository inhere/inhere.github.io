---
title: "GCli v3.5 release: shell completion, command middleware, grouped help and more"
...
- Full diff: [v3.3.1...v3.5.0](https://github.com/gookit/gcli/compare/v3.3.1...v3.5.0)
...
```text
$ myapp deploy
Please input your access token: _
```
...
GCli now supports merging short flags, for example `-a -u -x` becomes `-aux`, in a POSIX style. This is disabled by default and can be enabled via `Config.EnhanceShort`.
...
If you run into issues or have suggestions, open an issue or PR on [GitHub](https://github.com/gookit/gcli). For full API documentation, refer to [GoDoc](https://pkg.go.dev/github.com/gookit/gcli/v3).
