...
- :sparkles: up(env,sys): update some func and add new util func [9eaddb5](https://github.com/gookit/goutil/commit/9eaddb5669280dc91c989e4930ecd1efbdef18cf)
- :necktie: up(str): update the SplitInlineComment() logic [31445cd](https://github.com/gookit/goutil/commit/31445cd999e5577b9e7e7f6d3e9efe3289fd7131)
- :necktie: up(sys): update the SearchPath(), support limit result [67cbae1](https://github.com/gookit/goutil/commit/67cbae1d5db5c5ec09240917fae73c78e7d9e9d6)
...
- :necktie: feat: str - add some check util func [0e4792a](https://github.com/gookit/goutil/commit/0e4792acf21e1bf742f1af5882b74ff40c49b935)
- :necktie: feat: str/textutil - support quick replace vars for give text [ecc23cb](https://github.com/gookit/goutil/commit/ecc23cb0cec4c518623b08c37f2e1fd948d6bea2)
- :necktie: feat: sys,proc - add and update some util func [aa78114](https://github.com/gookit/goutil/commit/aa78114b0da1017f6456957ba86cd24eeebe5fc7)
- :sparkles: feat: fs - add more new fs util functions [3352512](https://github.com/gookit/goutil/commit/3352512f6a133ae15a57944bc54362b604c7ff95)
- :sparkles: feat: map, struct - add new util functions [90af09e](https://github.com/gookit/goutil/commit/90af09e118b4a521c19341e6b8a49a0890e22e7f)
- :sparkles: feat: stdio - add new util functions [ea243d6](https://github.com/gookit/goutil/commit/ea243d62c89dc9ec7be9fd6a9b0bcdb39bfd506b)
- :sparkles: feat: arr - add new util functions for in/notIn check [2a18ca2](https://github.com/gookit/goutil/commit/2a18ca2915c93e53aea74e86779943f04bd1910a)
- :sparkles: feat: testutil - add new util func IsMatchAll() [d0dade8](https://github.com/gookit/goutil/commit/d0dade8703da172f80424ff8c85ec759ec8273ae)
- :sparkles: feat: math - add new util func for compare value [176923b](https://github.com/gookit/goutil/commit/176923bb953622b995ed80017056cbe04db251cd)
- feat: error, test - add some new helper util fuctions [7188216](https://github.com/gookit/goutil/commit/718821631d8a7cc0567a2f39eece80f1b7c54157)
- :sparkles: feat: fs - add more make dir util func [c4447cb](https://github.com/gookit/goutil/commit/c4447cb0d32cec53221c3bb99a14ecefc4ec382e)
- :sparkles: feat: env,sys - add new func for get all env info map [b3d7669](https://github.com/gookit/goutil/commit/b3d7669d1a1c851d7f75e2a9ad449d74ca6c969c)
- :sparkles: feat: str - add new func for check ignore case string [746eb35](https://github.com/gookit/goutil/commit/746eb35d45a9c0d40fb9ae7945c9fe89bbc79765)
- :sparkles: feat: goutil - add new func for quick run go func [97a2863](https://github.com/gookit/goutil/commit/97a2863089d70a2d39f5fa720f74890767293d0b)
- :sparkles: feat: arr - add new func for quick convert slice type [75d8d89](https://github.com/gookit/goutil/commit/75d8d89f4cb7e9c59587caeccfeb73202beb42b1)
- :sparkles: feat: reflects - add new func for convert slice value and more util [f87fc86](https://github.com/gookit/goutil/commit/f87fc86119afd8418b47e93ad26b3925f78bef15)
- :sparkles: feat: structs - func InitDefaults() support set slice field [948fa70](https://github.com/gookit/goutil/commit/948fa703e7107edb4dc736aa041c260fc8df7d9b)
- :sparkles: feat: byte - add StrOrErr(), SafeString() for convert to string [767ed80](https://github.com/gookit/goutil/commit/767ed80a5e98d20b9e832a08d065de301ba0b4ec)
- :sparkles: feat: cmdr - add new option for output result to OS [6aaea78](https://github.com/gookit/goutil/commit/6aaea78dee886b7aa5483d71826a34813d8cd77b)

### Update

- :necktie: up: str, math - add new util func OrElse() [cb21fbc](https://github.com/gookit/goutil/commit/cb21fbc4624c800f9609137e053dfe2fef027190)
...
- :bug: up: textscan - fix multi inline comments parse error [bf68c94](https://github.com/gookit/goutil/commit/bf68c945ee79d7e214087ab117b55fa02b0f1c54)
...
- :necktie: up(env, str): update the env var parse and strutil.Valid() [5193849](https://github.com/gookit/goutil/commit/5193849498317900885f524fae7cf5777559f246)
